        ...
        <div class="row admin-page">
            <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1 col-xl-10 col-xl-offset-1">
                <div class="row section-name text-shadow">
                    <b><span class="color-black">Новая </span><span class="color-red">книга</span></b>
                </div>
            </div>
            <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1 col-xl-10 col-xl-offset-1 full-cart">
                <form action="<c:url value="/admin/book/save"/>" method="post" enctype="multipart/form-data">
                    <table class="table">
                        <tr>
                            <th>Название:</th>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                    <textarea class="input-order textarea" name="description" maxlength="500"
                                              placeholder=" Введите описание книги, год и т.д."></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th>Автор:</th>
                            <td>
                                    <textarea class="input-order textarea" name="author" maxlength="50"
                                              placeholder=" Введите имя автора"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th>Изображение:</th>
                            <td>
                                ...
                                <br><input type="file" name="bookImage" accept="image/*">
                            </td>
                        </tr>
                        <tr>
                            <th></th>
                            <td>
                                <button class="btn btn-success" type="submit"
                                        title="Добавить новую книгу">Добавить книгу
                                </button>
