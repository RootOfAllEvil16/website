...
<div class="container-fluid">
    <section id="books">
        <div class="row admin-page">
            <c:set var="books_length" value="${fn:length(books)}"/>
            <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1 col-xl-10 col-xl-offset-1">
                <div class="row section-name text-shadow">
                    <b>
                        <span class="color-black">Книги</span>
                        <c:if test="${books_length eq 0}">
                            <span class="color-red"> - список пуст!</span><br>
                            <a href="<c:url value="/admin/book/add"/>" title="Добавить новую книгу">
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <th>
                                ...
                                <a href="<c:url value="/admin/book/delete_all"/>"
                                   title="Удалить все книги">
                                    <button class="btn btn-danger" type="submit">Удалить ВСЕ</button>
                                </a>
                                <a href="<c:url value="/admin/chapter/all"/>" title ="Перейти к главам">
                                    <button class="btn btn-success" type="submit">Перейти к главам</button>
                                </a>
                            ...
                            <tr>
                                <td>
                                    <a href="<c:url value="/home"/>"
                                       title="Перейти к книге ${book.title}">${book.title}</a>
                                </td>
                                <td class="hidden-xs">${book.url}</td>
                                <td>
                                    <a href="<c:url value="/admin/book/view/${book.id}"/>"
                                       title="Просмотреть книгу ${book.title}">
